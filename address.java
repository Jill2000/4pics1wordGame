...
public class address extends JFrame implements MouseListener
{
	int get = 0;
	String bs;
	int bsi;
	...
	//Center Panel
	Icon ic1 = new ImageIcon("address1.jpg");
	Icon ic2 = new ImageIcon("address2.jpg");
	Icon ic3 = new ImageIcon("address3.jpg");
	Icon ic4 = new ImageIcon("address4.jpg");
	...
	public void lvl1()
	{
				...
				ltr[0] = new JLabel("A",JLabel.CENTER);
				ltr[1] = new JLabel("D",JLabel.CENTER);
				ltr[2] = new JLabel("D",JLabel.CENTER);
				ltr[3] = new JLabel("R",JLabel.CENTER);
				ltr[4] = new JLabel("E",JLabel.CENTER);
				ltr[5] = new JLabel("S",JLabel.CENTER);
				ltr[6] = new JLabel("S",JLabel.CENTER);
