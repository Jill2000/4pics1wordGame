...
public class level5 extends JFrame implements MouseListener
{
	int get = 0;
	String bs;
	int bsi;
	...
	//Center Panel
	Icon ic1 = new ImageIcon("lvl5(1pic).jpg");
	Icon ic2 = new ImageIcon("lvl5(2pic).jpg");
	Icon ic3 = new ImageIcon("lvl5(3pic).jpg");
	Icon ic4 = new ImageIcon("lvl5(4pic).jpg");
	...
	public void lvl1()
	{
				...
				ltr[0] = new JLabel("P",JLabel.CENTER);
				ltr[1] = new JLabel("R",JLabel.CENTER);
				ltr[2] = new JLabel("I",JLabel.CENTER);
				ltr[3] = new JLabel("V",JLabel.CENTER);
				ltr[4] = new JLabel("A",JLabel.CENTER);
				ltr[5] = new JLabel("T",JLabel.CENTER);
						...
						if(bblnk[i]==true)
						{
							...
							if(bblnk[6]== false)
							{
								...
								else
								{
									...
									Object[] option = {"Menu","Again"};
									int select;
									select = JOptionPane.showOptionDialog(null, "Wrong Guess","4PICs1WORD", JOptionPane.DEFAULT_OPTION,JOptionPane.QUESTION_MESSAGE,null,option,option[0]);
									boolean log, crt;
									
									if((log=(select==JOptionPane.YES_OPTION))==true)
									{  
										
										setVisible(false);
										
									}
									else if((crt=(select==JOptionPane.NO_OPTION))==true)
									{
										for(int m = 0; m < 7; m++)
										{
											blnk[m].setText("__");
									...
									else JOptionPane.showMessageDialog(null, "ERROR","FaceBaga",JOptionPane.ERROR_MESSAGE);
