...
public class weather extends JFrame implements MouseListener
{
	int get = 0;
	String bs;
	int bsi;
	...
	//Center Panel
	Icon ic1 = new ImageIcon("weather1.jpg");
	Icon ic2 = new ImageIcon("weather2.jpg");
	Icon ic3 = new ImageIcon("weather3.jpg");
	Icon ic4 = new ImageIcon("weather4.jpg");
	...
	public void lvl1()
	{
				...
				ltr[0] = new JLabel("W",JLabel.CENTER);
				ltr[1] = new JLabel("E",JLabel.CENTER);
				ltr[2] = new JLabel("A",JLabel.CENTER);
				ltr[3] = new JLabel("T",JLabel.CENTER);
				ltr[4] = new JLabel("H",JLabel.CENTER);
				ltr[5] = new JLabel("E",JLabel.CENTER);
				ltr[6] = new JLabel("R",JLabel.CENTER);
